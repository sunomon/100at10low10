...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(hours=1):
            ...
            target7_price = get_target7_price("KRW-CBK", 1)
            target8_price = get_target8_price("KRW-CBK", 1.5)
            target9_price = get_target9_price("KRW-CBK", 2)
            target10_price = get_target10_price("KRW-CBK", 3)
